...
$users_expiredDate = trim($_GET["users_expiredDate"]);
$users_registerDate = trim($_GET["users_registerDate"]);
...
if (sizeof($result_array) > 0) {
    ...
    foreach ($result_array as $data) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue($l11, $data["users_registerDate"])
            ->setCellValue($l12, $data["users_expiredDate"]);
    }
}
// 重新命名工作表
