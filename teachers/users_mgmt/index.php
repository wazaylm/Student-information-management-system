            ...
            <div class="photos">
                ...
                <div align="center" style="padding: 5px">
                    ...
                    <tr>
                        ...
                        <td><input name="users_school" id="users_school"
                                   value="<?php echo $_COOKIE['lib_users_school'] ?>" type="text" size="50"
                                   maxlength="50"/></td>
                    </tr>
                    ...
                    <table width="500" border="0">
                        <tr>
                            ...
                            <td>
                                <input onclick="add()" name="submit" value="用户添加" type="submit"
                                       class="button_style"/>
                            </td>
                            <td>
                                <input onclick="add()" name="submit" value="用户添加" type="submit"
                    ...
                    <?php
                    include "../../database/Catalog_class.php";
                    print_r($arr_data);
                    ?>
